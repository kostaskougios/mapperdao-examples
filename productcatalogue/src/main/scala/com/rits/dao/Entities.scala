...
object ProductEntity extends Entity[IntId, Product] {
	 ...
	 */
	def constructor(implicit m) = new Product(title, description, prices, attributes, categories, tags) with IntId {
...
object CategoryEntity extends Entity[IntId, Category] {
	...
	def constructor(implicit m) = new Category(name, parent) with IntId {
